                              ...
                              <div class="form-group">
                                ...
                                <select class="form-control" id="se-warna-f1-ra" >
                                    <option value="">--Pilihan--</option>
                                      <?php
                                            include("connect.php");
                                            $angkot=mysqli_query($conn,"select * from angkot_color ");
                                            while($rowangkot = mysqli_fetch_array($angkot))
                                            {
                              ...
                              <div class="form-group">
                                ...
                                <select class="form-control" id="se-kondisi-f1-y" >
                                    <option value="">--Pilihan--</option>
                                      <?php
                                            include("connect.php");
                                            $angkot=mysqli_query($conn,"select * from facility_condition ");
                                            while($rowangkot = mysqli_fetch_array($angkot))
                                            {
                                              echo"<option value=".$rowangkot['id'].">".$rowangkot['kondisi']."</option>";
                                            }
                                        ?>
                                </select>
                                <br>
