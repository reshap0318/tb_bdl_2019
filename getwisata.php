...
$querysearch ="SELECT h.id_hotel, nama_hotel, h.alamat, st_x(st_centroid(h.geom)) as longitude,
st_y(st_centroid(h.geom)) as latitude, ow.id_, ST_Distance_Sphere(h.geom, ow.geom)/1000 as jarak_dari_ik from hotel h, industri_kecil ow where ow.id_industri='".$idik."' and ((ST_Distance_Sphere(h.geom, ow.geom)/1000>=0.5) and (ST_Distance_Sphere(h.geom, ow.geom)/1000<=1)) ";
