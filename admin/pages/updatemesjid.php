<div class="col-sm-6"> <!-- menampilkan peta-->
    ...
    <section class="panel">
				...
				$id=$_GET['id'];
				$sql = mysqli_query($conn,"SELECT id, name, address, capacity, ST_AsText(geom) as geom, id_category, image, land_size, building_size, park_area_size, est, last_renovation, jamaah, imam, teenager FROM worship_place where id='$id'");
