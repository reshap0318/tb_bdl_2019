                    ...
                    <div class="panel-body">
                      ...
                      <div class="form-group">
                       <table id="example1" class="table table-hover table-bordered table-striped">
                        ...
                        <a href="act/delevent.php?id_worship_place=<?php echo $id; ?>&date=<?php echo $tgl_keg; ?>&time=<?php echo $jam; ?>" class="btn btn-sm btn-default" title='Delete'><i class="fa fa-trash-o"></i></a>
                        </div>
                        </td>
                        </tr>
                        <?php } ?>
