...
$sql = mysqli_query($conn,"insert into worship_place (id, name, address, capacity, geom, id_category, image, land_size, building_size, park_area_size, est, last_renovation, jamaah, imam, teenager) values ('$id', '$nama', '$alamat', '$kapasitas', ST_GeomFromText('$geom'), '$kategori', '$name', '$luas_tanah', '$luas_bangunan', '$luas_area_parkir', '$thn_berdiri', '$thn_renovasi_terakhir', '$jml_jamaah', '$jml_imam', '$jml_remaja')");
